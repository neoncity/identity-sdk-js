...
describe('User', () => {
    const UserTestCases = [
	{
	    user: new User(1, UserState.Active, Role.Admin, '', new Date(Date.UTC(2017, 1, 17)), new Date(Date.UTC(2017, 1, 17)), '', '', 'en'),
	    isAdmin: true
	},
	{
	    user: new User(1, UserState.Active, Role.Regular, '', new Date(Date.UTC(2017, 1, 17)), new Date(Date.UTC(2017, 1, 17)), '', '', 'en'),
	    isAdmin: false
	}
    ];
